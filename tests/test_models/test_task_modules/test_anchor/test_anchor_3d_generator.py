...
def test_anchor_3d_range_generator():
    ...
    DefaultScope.get_instance('test_ancho3drange_generator', scope_name='mmdet3d')
...
def test_aligned_anchor_generator():
    ...
    assert hasattr(mmdet3d.models.task_modules, 'AlignedAnchor3DRangeGenerator')
...
def test_aligned_anchor_generator_per_cls():
    ...
    assert hasattr(mmdet3d.models.task_modules, 'AlignedAnchor3DRangeGeneratorPerCls')
    DefaultScope.get_instance(
