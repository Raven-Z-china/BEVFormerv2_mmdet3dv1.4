...
def test_monoflex_bbox_coder():
    bbox_coder_cfg = dict(
        ...
        base_dims=(
            (3.8840, 1.5261, 1.6286, 0.4259, 0.1367, 0.1022),
    ...
    preds = bbox_coder.decode(
        regression, base_centers2d, labels, downsample_ratio, cam2imgs
    )
    ...
    locations = bbox_coder.decode_location(
        base_centers2d, offsets_2d, depths, cam2imgs, downsample_ratio
    )
