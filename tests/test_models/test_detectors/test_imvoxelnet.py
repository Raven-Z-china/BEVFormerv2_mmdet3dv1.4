...
class TestImVoxelNet(unittest.TestCase):
    def test_imvoxelnet_kitti(self):
        ...
        DefaultScope.get_instance('test_imvoxelnet_kitti', scope_name='mmdet3d')
        setup_seed(0)
        imvoxel_net_cfg = get_detector_cfg('imvoxelnet/imvoxelnet_8xb4_kitti-3d-car.py')
    ...
    def test_imvoxelnet_sunrgbd(self):
        ...
        assert hasattr(mmdet3d.models, 'ImVoxelNet')
        DefaultScope.get_instance('test_imvoxelnet_sunrgbd', scope_name='mmdet3d')
        setup_seed(0)
