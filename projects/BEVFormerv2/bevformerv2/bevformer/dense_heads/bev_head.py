...
import mmcv
import cv2 as cv
from projects.BEVFormerv3.bevformerv2.bevformer.modules import PerceptionTransformerBEVEncoder
...
class BEVHead(BaseModule):
    def __init__(self, 
        ...
        self.transformer :PerceptionTransformerBEVEncoder = TASK_UTILS.build(transformer)
        self.positional_encoding = build_positional_encoding(positional_encoding)

        pts_bbox_head_3d.update(kwargs)
        self.pts_bbox_head_3d = TASK_UTILS.build(pts_bbox_head_3d)
