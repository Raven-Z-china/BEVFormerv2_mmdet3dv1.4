...
class BEVFormerHead(DETRHead_old):
    """Head of Detr3D.
    ...
    def _get_target_single(
        ...
        pred_results = InstanceData()
        pred_results.priors = bbox_pred

        gt_results = InstanceData()
        gt_results.bboxes_3d = gt_bboxes

        sampling_result = self.sampler.sample(assign_result, pred_results, gt_results)
        ...
        # bbox targets
        bbox_targets = torch.zeros_like(bbox_pred, dtype=gt_bboxes.dtype)[..., :gt_c]
