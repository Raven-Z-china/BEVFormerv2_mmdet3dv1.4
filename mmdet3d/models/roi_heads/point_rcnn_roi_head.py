...
class PointRCNNRoIHead(Base3DRoIHead):
    ...
    def loss(
        ...
        **kwargs
        ...
        bbox_results = self._bbox_forward_train(features, fp_points, sample_results)
        losses = dict()
    ...
    def predict(
        ...
        **kwargs
        ...
        bbox_results = self._bbox_forward(features, fp_points, batch_size, rois)
    ...
    def _bbox_forward_train(
        self, features: Tensor, points: Tensor, sampling_results: SampleList
    ) -> dict:
    ...
    def _bbox_forward(
        self, features: Tensor, points: Tensor, batch_size: int, rois: Tensor
    ) -> dict:
        ...
        """
        pooled_point_feats = self.bbox_roi_extractor(features, points, batch_size, rois)
