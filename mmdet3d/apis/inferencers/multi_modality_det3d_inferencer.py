...
class MultiModalityDet3DInferencer(Base3DInferencer):
    ...
    def _inputs_to_list(
        self, inputs: Union[dict, list], cam_type: str = 'CAM2', **kwargs
    ) -> list:
        ...
        if isinstance(inputs, dict):
            ...
            for input in inputs:
                ...
                assert len(info_list) == 1, (
                    'Only support single sample' 'info in `.pkl`, when input is a list.'
                )
    ...
    def visualize(
        ...
        for single_input, pred in zip(inputs, preds):
            ...
            if isinstance(points_input, str):
                ...
                raise ValueError('Unsupported input type: ' f'{type(points_input)}')
            ...
            if isinstance(single_input['img'], str):
                ...
                raise ValueError('Unsupported input type: ' f'{type(img_input)}')
