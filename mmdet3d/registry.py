...
HOOKS = Registry('hook', parent=MMENGINE_HOOKS, locations=['mmdet3d.engine.hooks'])

# manage data-related modules
DATASETS = Registry('dataset', parent=MMENGINE_DATASETS, locations=['mmdet3d.datasets'])
...
TRANSFORMS = Registry(
    'transform', parent=MMENGINE_TRANSFORMS, locations=['mmdet3d.datasets.transforms']
)
...
MODEL_WRAPPERS = Registry(
    'model_wrapper', parent=MMENGINE_MODEL_WRAPPERS, locations=['mmdet3d.models']
)
...
METRICS = Registry('metric', parent=MMENGINE_METRICS, locations=['mmdet3d.evaluation'])
# manage evaluator
EVALUATOR = Registry(
...
VISUALIZERS = Registry(
    'visualizer', parent=MMENGINE_VISUALIZERS, locations=['mmdet3d.visualization']
)
# manage visualizer backend
VISBACKENDS = Registry(
    'vis_backend', parent=MMENGINE_VISBACKENDS, locations=['mmdet3d.visualization']
)
...
INFERENCERS = Registry(
    'inferencer', parent=MMENGINE_INFERENCERS, locations=['mmdet3d.api.inferencers']
)
